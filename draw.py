...
class PeopleGraph:
    ...
    def create_graph(self):
        ...
        for edge in self.G.edges:
            ...
            nx.draw_networkx_edges(self.G, NewPos, edgelist=[edge], width=1.4, arrows=True, arrowstyle=patches.ArrowStyle(self.people[target_node]["state"], head_length=0.5, head_width=0.1), connectionstyle="arc3, rad=0.2", arrowsize=20)
    ...
    def show_graph(self,filename):
        ...
        filename = f"{filename}_{Getdatetime()}.png"
